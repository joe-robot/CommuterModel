...
CommuterModel: clean_compiled_files
	...
	$(MPICXX) $(REPAST_HPC_DEFINES) $(BOOST_INCLUDE) $(REPAST_HPC_INCLUDE) -I./include -c ./src/Infrastructure.cpp -o ./objects/Infrastructure.o
	$(MPICXX) $(BOOST_LIB_DIR) $(REPAST_HPC_LIB_DIR) -o ./bin/CommuterModel.exe  ./objects/Main.o ./objects/CommuterModel.o ./objects/Commuter.o ./objects/Infrastructure.o $(REPAST_HPC_LIB) $(BOOST_LIBS)
